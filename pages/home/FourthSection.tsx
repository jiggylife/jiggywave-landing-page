		...
		<Container>
			<div className="content">
				...
				<div className="content__right">
					...
					<Text
						type="body"
						text="We give users daily interest daily based on how much you deposit. The interest comes daily and it can be between 1% and 3.5%. This means that if you have ₦50k in your wallet, you can earn up to ₦1,500 everyday."
